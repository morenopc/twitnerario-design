# Django settings for twitnerario project.
import os, sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'twitnerario.db'),                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'twitnerario-design.urls'
